...
function App (props) {
  ...
  const fetchData = () => {
    ...
    let url = 'https://it4883logging.herokuapp.com/api/incident?';
  ...
  return (
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
          ...
          <br />
            <ProblemActivity data={logActivityData} loading={!isLoadedLogActivityData} rangeTime={rangeTime} projectType={projectType} />
