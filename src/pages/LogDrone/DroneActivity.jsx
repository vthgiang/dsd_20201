    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, row) => {
          ...
          return (<div>
            <PopoverShowApp droneName={row.name} droneId={row.entityId} rangeTime={this.props.rangeTime} projectType={this.props.projectType} />
          </div>
...
const ModalShowApp = (props) => {
  ...
  return (
    <>
      ...
      <Modal width={1000} title={ props.droneName + ', mã id ' +props.droneId} visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
        {clicked && props.actionType === 'log_payload' && <LogPayload droneId={props.droneId} rangeTime={props.rangeTime} projectType={props.projectType} />}
        {clicked && props.actionType === 'log_video' && <LogVideo droneId={props.droneId} rangeTime={props.rangeTime} projectType={props.projectType} />}
        {clicked && props.actionType === 'log_image' && <LogImage droneId={props.droneId} rangeTime={props.rangeTime} projectType={props.projectType} />}
      </Modal>
    </>
  );
};
    ...
    const content = (
      <div>
        ...
        <Row style={{width: '400px'}} gutter={[10,10]}>
          <Col span={12}>
            <ModalShowApp droneId={this.props.droneId} droneName={this.props.droneName} hidePopover={this.hide} actionType='log_payload' rangeTime={this.props.rangeTime} projectType={this.props.projectType} />
          </Col>
          <Col span={12}>
            <ModalShowApp droneId={this.props.droneId} droneName={this.props.droneName} hidePopover={this.hide} actionType='log_video' rangeTime={this.props.rangeTime} projectType={this.props.projectType} />
          </Col>
          <Col span={12}>
            <ModalShowApp droneId={this.props.droneId} droneName={this.props.droneName} hidePopover={this.hide} actionType='log_image' rangeTime={this.props.rangeTime} projectType={this.props.projectType} />
          </Col>
        </Row>
