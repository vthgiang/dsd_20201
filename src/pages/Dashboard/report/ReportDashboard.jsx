...
import { getReportsAllMetrics } from "../../../services/statistics";
import { useSelector } from "react-redux";

export default function ReportDashboard() {
    const user = useSelector(state => state.user);
    const { api_token, full_name } = user.user;
    ...
    React.useEffect(() => {
        const fetchAll = async () => {
            const reports = await getReportsAllMetrics(api_token);
        ...
        <>
            ...
            {!reportMetrics ? (
                <Spin />
                    ...
                    <Row>
                        <Col span="12">
                            <h3>Số lượng báo cáo theo tháng được gửi cho {full_name}</h3>
