...
import WarnActivity from './WarnActivity';
...
function App (props) {
  ...
  const fetchData = (fromDate, toDate) => {
    ...
    if (fromDate && toDate && projectType === 'all_project') {  
      url = 'https://it4883logging.herokuapp.com/api/warning?minDate=' + fromDate +'&maxDate=' + toDate;
    } else if (fromDate && toDate && projectType !== 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/warning?minDate=' + fromDate +'&maxDate=' + toDate +'&projectType=' + projectType;
    } else if (projectType === 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/warning?projectType=de_dieu';
    } else {
      url = 'https://it4883logging.herokuapp.com/api/warning?projectType=' + projectType;
    }
    ...
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
        ...
        >
          ...
          <br />
            <WarnActivity data={logActivityData} loading={!isLoadedLogActivityData}/>
