  ...
  return (
    <div>
      ...
      >
        ...
        <Breadcrumb.Item>Drone</Breadcrumb.Item>
      </Breadcrumb>
      <Row>
        <Col span={24}>
          <Card className="u-shadow u-rounded">
            <div style={{ marginBottom: 16 }}>
              ...
              <Select defaultValue="1" style={{ marginRight: 16 }}>
                ...
                <Option value="2">Báo cáo drone hỏng hóc</Option>
                <Option value="3">Chi phí sửa chữa drone</Option>
                <Option value="4">Chi phí bảo trì drone</Option>
              </Select>
