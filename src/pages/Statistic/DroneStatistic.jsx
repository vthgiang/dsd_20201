...
export default function DroneStatistic() {
    ...
    return (
        ...
        <>
            <div className="row" style={{ height: "100px", alignItems: "center", justifyContent: "center" }}>
                <div className="col-md-1"></div>
                <div className="col-md-3">
                    <h2>{numDrone} drone</h2>
                </div>
                <div className="col-md-4">
                    <span style={{ marginRight: '10px' }}>Trạng thái: </span>
                    <select value={stateDrone} style={{ height: '36px', width: '150px' }}
