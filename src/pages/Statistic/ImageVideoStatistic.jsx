...
import { columns, data, problemTypes } from '../ImageVideo/config';
import axios from 'axios';

const { Title, Text } = Typography;
const { Option } = Select;

export default function ImageVideoStatistic() {
  ...
  return (
    <Container>
      <TitleCustom level={2}>Thống kê hình ảnh, video</TitleCustom>
      <SpaceCustom>
        <Space direction="horizontal">
          <Text style={{ marginRight: '16px' }}>Ngày:</Text>
          <DatePicker style={{ marginRight: '16px' }} placeholder="Chọn ngày" onChange={onChangeDate} />
        </Space>
        <Space direction="horizontal">
          <Text style={{ marginRight: '10px', marginLeft: '40px' }}>Sự cố:</Text>
          <Select placeholder="Chọn sự cố" style={{ minWidth: 100, marginRight: '40px' }} allowClear onChange={onChangeProblem}>
