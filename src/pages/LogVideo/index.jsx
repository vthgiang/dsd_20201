...
function App () {
  ...
  const fetchData = (fromDate, toDate) => {
    ...
    if (fromDate && toDate && projectType === 'all_project') {  
      url = 'https://it4883logging.herokuapp.com/api/video?minDate=' + fromDate +'&maxDate=' + toDate;
    } else if (fromDate && toDate && projectType !== 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/video?minDate=' + fromDate +'&maxDate=' + toDate +'&projectType=' + projectType;
    } else if (projectType === 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/video?projectType=de_dieu';
    } else {
      url = 'https://it4883logging.herokuapp.com/api/video?projectType=' + projectType;
    }
    ...
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
        ...
        >
          ...
          <br />
            <VideoActivity data={logActivityData} loading={!isLoadedLogActivityData}/>
