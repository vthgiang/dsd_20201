...
function App (props) {
  ...
  const fetchData = () => {
    ...
    let url = 'https://it4883logging.herokuapp.com/api/video?';
  ...
  return (
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
          ...
          <br />
            <VideoActivity data={logActivityData} loading={!isLoadedLogActivityData} rangeTime={rangeTime} projectType={projectType} />
