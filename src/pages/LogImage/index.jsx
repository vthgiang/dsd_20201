...
function App () {
  ...
  const fetchData = (fromDate, toDate) => {
    ...
    if (fromDate && toDate && projectType === 'all_project') {  
      url = 'https://it4883logging.herokuapp.com/api/image?minDate=' + fromDate +'&maxDate=' + toDate;
    } else if (fromDate && toDate && projectType !== 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/image?minDate=' + fromDate +'&maxDate=' + toDate +'&projectType=' + projectType;
    } else if (projectType === 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/image?projectType=de_dieu';
    } else {
      url = 'https://it4883logging.herokuapp.com/api/image?projectType=' + projectType;
    }
    ...
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
        ...
        >
          ...
          <br />
            <ImageActivity data={logActivityData} loading={!isLoadedLogActivityData}/>
