      ...
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
          ...
          <br />
            ...
            />
            {
              filteredObject != null && 
              <Collapse>
                <Panel header={"Xem các drone tại đợt giám sát: " + filteredObject.name} key="1">
                  <LogDrone projectType={projectType} rangeTime={rangeTime} uavConnectId={filteredObject.entityId}/>
                </Panel>
              </Collapse>
            }
