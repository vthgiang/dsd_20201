...
function App (props) {
  ...
  const fetchData = (fromDate, toDate) => {
    ...
    if (fromDate && toDate && projectType === 'all_project') {  
      url = 'https://it4883logging.herokuapp.com/api/monitor-object?minDate=' + fromDate +'&maxDate=' + toDate;
    } else if (fromDate && toDate && projectType !== 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/monitor-object?minDate=' + fromDate +'&maxDate=' + toDate +'&projectType=' + projectType;
    } else if (projectType === 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/monitor-object?projectType=de_dieu';
    } else {
      url = 'https://it4883logging.herokuapp.com/api/monitor-object?projectType=' + projectType;
    }
  ...
  return (
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
        ...
        >
          <h2>
            Lịch sử log đối tượng giám sát
          </h2>
          <br />
          <Form layout="inline">
            <Form.Item
          ...
          <br />
            <ObjMonitorActivity data={logActivityData} loading={!isLoadedLogActivityData}/>
