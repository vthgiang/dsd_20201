...
function App (props) {
  ...
  const fetchData = (fromDate, toDate) => {
    ...
    if (fromDate && toDate && projectType === 'all_project') {  
      url = 'https://it4883logging.herokuapp.com/api/user?minDate=' + fromDate +'&maxDate=' + toDate;
    } else if (fromDate && toDate && projectType !== 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/user?minDate=' + fromDate +'&maxDate=' + toDate +'&projectType=' + projectType;
    } else if (projectType === 'all_project') {
      url = 'https://it4883logging.herokuapp.com/api/user?projectType=de_dieu';
    } else {
      url = 'https://it4883logging.herokuapp.com/api/user?projectType=' + projectType;
    }
    ...
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
        ...
        >
          ...
          <br />
            <UserActivity data={logActivityData} loading={!isLoadedLogActivityData}/>
