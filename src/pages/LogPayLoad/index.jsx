...
function App (props) {
  ...
  const fetchData = () => {
    ...
    let url = 'https://it4883logging.herokuapp.com/api/payload?';
  ...
  return (
    <>
      <Col style={{ marginRight: '4%', marginTop: 20 }}>
          ...
          <br />
            <PayloadActivity data={logActivityData} loading={!isLoadedLogActivityData} rangeTime={rangeTime} projectType={projectType} />
